...
class Testpublic():
    ...
    def test_ipnetwork_for_ipv6(self):
        public.__pillar__ = {'public_network': 'fd00::/64'}
        result = public._ipnetwork(6)
        assert result

    def test_ipnetwork_without_ipv6(self):
        public.__pillar__ = {'public_network': '192.168.0.0/24'}
        result = public._ipnetwork(6)
        assert result == False

    def test_ipnetwork_for_ipv4(self):
        public.__pillar__ = {'public_network': '192.168.0.0/24'}
        result = public._ipnetwork(4)
        assert result

    def test_ipnetwork_without_ipv4(self):
        public.__pillar__ = {'public_network': 'fd00::/64'}
        result = public._ipnetwork(4)
        assert result == False
